# Generated by Django 6.0.3 on 2026-04-12 02:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_profile_cpf_profile_mobile'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foruns.post')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.user')),
            ],
            options={
