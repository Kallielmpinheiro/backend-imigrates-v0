...
from apps.forum.schemas import  CreatePostResponseRequest, PostResponseResponse, UpdatePostResponseRequest
from apps.forum.models import Post, PostResponse
...
@router.post('', auth=JWTAuth(), response={201: PostResponseResponse, 400: dict, 401: dict, 404: dict})
